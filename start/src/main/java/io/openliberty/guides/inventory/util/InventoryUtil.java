...
public class InventoryUtil {
   ...
   *          - name of host.
   * @param port
   *          - port number for the system service.
   * @return JSON Java object containing the system properties of the host's
   *         JVM.
   */
  ...
  /**
   * <p>
   * Creates a JAX-RS client that retrieves the JVM system properties for the
   * particular host on the given port number.
   * </p>
   */
  ...
  /**
   * <p>
   * Returns whether or not a particular host is exposing its JVM's system
   ...
   * <p>
   * Returns whether or not a particular host is exposing its JVM's system
   * properties on the given port number. In other words, returns whether or not
  ...
  /**
   * <p>
   * Returns whether or not a particular host is running the system service on
