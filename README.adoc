...
that have been enabled through MicroProfile Metrics. Log in with `confAdmin` as your username and
`microprofile` as your password. You see only the system metrics because the server just started,
...
To see whether the tests detect a failure, go to the `MetricsTest.java` file and change any assertion
