...
First, point your browser to `/inventory/systems` endpoint. As you can see, there are no
...
not expose metrics if you do not point your browser first to `/inventory/systems/` endpoint. This is
...
As you can see, there are two metrics annotations. They are:
