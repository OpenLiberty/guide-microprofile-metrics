...
In addition, a few endpoint tests, `start/src/test/java/it/io/openliberty/guides/inventory/InventoryEndpointTest.java`
and `start/src/test/java/it/io/openliberty/guides/system/SystemEndpointTest.java`, are provided for you to
