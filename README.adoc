...
:page-related-guides: ['microprofile-health', 'cdi-intro']
...
* The `unit` field has a default value of `seconds`.
...
* The `absolute` field is set to `true` to give the metric the name of the method (without the class and package names).
