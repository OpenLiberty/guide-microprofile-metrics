...
|===
| *Field* | *Purpose*
| `absolute` | Gives the metric the name of the method (without the class and package names) if it is set to `true`.
| `monotonic` | Makes the counter increment only if it is set to `true`.
|===
