...
The MicroProfile Metrics feature helps to create and register metrics by using Contexts and Dependency 
Injection (CDI).  

You will access useful JVM/server base metrics and also registries that contain all registered metrics
and metadata.
...
showing useful JVM/server base details at the following URL:

* `\http://localhost:9080/metrics`

You can find specific metrics about your application at the following URL:
