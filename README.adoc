...
[role="no_copy"]
----
# HELP servlet_request_total The number of visits to this servlet since the start of the server.
...
the https://openliberty.io/docs/latest/reference/javadoc/microprofile-7.0-javadoc.html?class=org/eclipse/microprofile/metrics/annotation/package-summary.html&package=allclasses-frame.html[MicroProfile Metrics Annotation Javadoc^].
