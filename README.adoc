...
Liberty as a vendor supplies server component metrics when [hotspot=mpMetrics]`mpMetrics` features is enabled in the [hotspot]`server.xml` configuration file.
