...
:page-seo-title: Monitoring the metrics of a Java microservice using Eclipse MicroProfile Metrics
:page-seo-description: A tutorial on how to expose both system and custom application metrics from a Java microservice and monitor endpoints using Eclipse MicroProfile Metrics.
...
When you have finished checking out the service, exit out of development mode by typing `q` in the shell session
