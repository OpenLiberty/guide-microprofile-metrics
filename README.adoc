...
Otherwise, the metric value should be scaled to the base unit of the respective known unit family, for example, unit family `MetricUnits.Percent` with base unit `ratio`.
|===
