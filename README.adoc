...
Point your browser to the `http://localhost:9080/inventory/systems`[window="_blank"] URL to access the `inventory`
...
Access the `inventory` service at the `http://localhost:9080/inventory/systems`[window="_blank"] URL at least once
for application metrics to be collected. Otherwise, the metrics will not appear.

Next, point your browser to the `https://localhost:9443/metrics[window="_blank"]` MicroProfile Metrics endpoint. Log in
as the `admin` user with `adminpwd` as the password. You can see both the system and application
metrics in a text format.

To see only the application metrics, point your browser to `https://localhost:9443/metrics/application`[window="_blank"].
...
To see only the system metrics, point your browser to `https://localhost:9443/metrics/base`[window="_blank"].
...
Point your browser to the `https://localhost:9443/metrics`[window="_blank"] URL to review the all available metrics
...
Next, point your browser to the `http://localhost:9080/inventory/systems`[window="_blank"] URL. Reload the
`https://localhost:9443/metrics`[window="_blank"] URL, or access only the application metrics at the
`https://localhost:9443/metrics/application`[window="_blank"] URL.
