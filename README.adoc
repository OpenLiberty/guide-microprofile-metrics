...
You will learn how to use the MicroProfile Metrics feature to provide metrics from a RESTful application.
...
such as disk usage growing without bounds. They can also help those scheduling systems to decide when
