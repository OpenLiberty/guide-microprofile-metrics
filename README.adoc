...
|[hotspot=24]`absolute` | Optional. Use this field to determine whether the metric name is the exact name that is specified in the `name` field or that is specified with the package prefix.
