...
You will learn how to use MicroProfile Metrics to provide metrics from a microservice. You can then 
monitor these metrics to determine the health of a service. You can also use them to pinpoint issues, 
