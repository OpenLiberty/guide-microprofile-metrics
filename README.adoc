...
To run the test cases in a particular order, put them in a [hotspot=testSuite file=0]`testSuite()` method.
Label the method with the [hotspot=Test file=0]`@Test` annotation, which automatically runs when your test class runs.
