...
[source, java, linenums, role='code_column hide_tags=copyright tags=InventoryManager']
----
...
== Testing the metrics
MetricsTest.java
[source, java, linenums, role='code_column hide_tags=copyright tags=MetricsTest']
----
